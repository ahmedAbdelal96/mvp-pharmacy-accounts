  ...
  return (
    <div>
      <div className="page-header">
        <h2 className="page-title">تقرير الأطراف التي لها</h2>
        <p className="page-description">الأطراف التي لهم فلوس عندنا (له)</p>
      </div>

      <div className="card max-w-2xl">
        <p className="text-zinc-500 text-sm mb-4">
          هذا التقرير يعرض جميع الأطراف اللي لهم فلوس عندنا (سالب).
        </p>
